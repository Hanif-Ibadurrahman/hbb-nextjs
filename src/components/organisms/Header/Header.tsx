              ...
              <ul className="dropdown-menu animated bounceIn">
                ...
                <li>
                  <ul className="menu sm-scrol">
                    ...
                    <li>
                      <a href="#">
                        <i className="fa fa-users text-danger"></i> Donec at nisi sit amet tortor
                        commodo porttitor pretium a erat.
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i className="fa fa-shopping-cart text-success"></i> In gravida mauris et
                        nisi
                      </a>
                    </li>
                    <li>
                      <a href="#">
                        <i className="fa fa-user text-danger"></i> Praesent eu lacus in libero
                        dictum fermentum.
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="#">
                        <i className="fa fa-user text-success"></i> Nullam euismod dolor ut quam
