                  ...
                  <div className="row g-0 row-cols-auto">
                    <div className="col">
                      <div className="section-bx">
                        <a href="#" className="bg-warning-light d-block rounded10 m-5 h-40 w-40">
                    ...
                    <div className="col">
                      <div className="section-bx">
                        <a href="#" className="bg-warning d-block rounded10 m-5 h-40 w-40">
                          <div className="bx-dec">
                            <div className="section-dec d-flex align-items-center">
                              <div className="box-img">
                                <img src="../images/box.png" className="img-fluid" alt="" />
                              ...
                              <div className="dec">
                                <h4 className="my-0 text-white">Row 3 #124578</h4>
                                <p className="text-white">H60 x W60 x 20 KG</p>
                                <p className="text-white-50 mb-0">Delivered 06:15PM</p>
                              </div>
                            </div>
                          </div>
                        </a>
                  ...
                  <tr>
                    ...
                    <td>
                      <span className="text-muted text-nowrap">
                        <i className="fa fa-calendar-o text-success-light mx-5"></i> 05-12-2021
                      </span>{' '}
                    </td>
                    <td>
